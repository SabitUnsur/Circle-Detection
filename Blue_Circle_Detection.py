...
while True:
    ...
    lower_blue = np.array([20, 115, 70])
    # Algılamak istediğimiz en düşük MAVİ renk kodu belirlenir

    upper_blue = np.array([255, 145, 100])
    # Algılamak istediğimiz en yüksek MAVİ renk kodu belirlenir

    masked_frame = cv2.inRange(frame_lab, lower_blue, upper_blue)
    ...
    # İstediğimiz MAVİ renk skalasındaki görüntü Blurlanır
